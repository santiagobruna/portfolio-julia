        ...
        <Container id="convenios">
            ...
            <div className="flex justify-center flex-wrap gap-32">
                <div className="flex flex-col items-center gap-2 ">
                    <img className="cursor-pointer" src="./src/assets/first-aid.svg" alt="Ícone de linha horizontal" width={'55px'}/>
                    <span className="font-bold">Saúde Social</span>
                </div>
                <div  className="flex flex-col items-center gap-2">
                    <img className="cursor-pointer" src="./src/assets/heartbeat.svg" alt="Ícone de linha horizontal" width={'55px'} />
